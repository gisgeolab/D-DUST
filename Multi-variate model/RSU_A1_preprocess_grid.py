...
def preprocess_grid(params):
    ...
    try:
        preprocdb = pd.read_csv(dspath+'workflow\\'+'DS_WT_preprocessed_set.csv')
    except:
        try:
            surrmap = pd.read_csv(dspath+'workflow\\'+'DS_WT_surroundings_map.csv')
        except:
        ...
        preprocmap = pd.read_excel(dspath+'workflow\\'+'DS_preprocessing_map.xlsx')
        ...
        for r in preprocmap.iterrows():
            ...
            for c in cellslist:
                ...
                ici = ici + 1
        preprocdb.to_csv(dspath+'workflow\\'+'DS_WT_preprocessed_set.csv')
    ...
    outdb.to_csv(dspath+'workflow\\'+'DS_'+version+'_'+model+'_preprocessed_set.csv',encoding='ISO-8859-1',index=False)
